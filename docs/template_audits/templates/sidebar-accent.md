...
|----|------|----------|-------------|-------|--------|
| SAC-004 | profile_card_radius | minor | Profile/summary card has inconsistent border-radius compared to entry cards. | 2026-03-21 | resolved |
| SAC-005 | skill_chip_bg | minor | Skill chips use white bg creating high contrast against tinted sidebar. Reference shows matching bg. | 2026-03-21 | resolved |
| SAC-006 | contact_weight | minor | Contact labels use font-semibold, heavier than needed for sidebar context. Reference shows font-medium. | 2026-03-21 | resolved |
...
| SAC-004 | profile_card_radius | minor | Changed rounded-[1.75rem] → rounded-2xl for consistency | 2026-03-22 | Matches entry card radius |
| SAC-005 | skill_chip_bg | minor | Changed white bg → accent_color_with_alpha("08") | 2026-03-22 | Blends with tinted sidebar |
| SAC-006 | contact_weight | minor | Changed font-semibold → font-medium on contact labels | 2026-03-22 | Lighter sidebar feel |
...
- **2026-03-22** — Full-cycle: resolved SAC-004 (profile card radius), SAC-005 (skill chip bg), SAC-006 (contact weight). 0 discrepancies remain. Advanced to `pixel_perfect`.
