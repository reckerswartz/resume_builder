...
RSpec.describe 'Admin::Settings', type: :request do
  ...
  describe 'GET /admin/settings' do
    ...
    it 'renders the grouped settings hub' do
      ...
      expect(response.body).not_to include(I18n.t('admin.settings.show.summary.eyebrow'))
      expect(response.body).not_to include(I18n.t('admin.settings.show.summary.readiness_badge'))
