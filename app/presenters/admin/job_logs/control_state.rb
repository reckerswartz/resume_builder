  ...
  module JobLogs
    class ControlState
      ...
      def requeue_available?
        job_log.failed? || orphaned_requeue_available?
      end

      def requeue_label
        if orphaned_requeue_available?
      ...
      def summary
        ...
        return I18n.t("admin.job_logs.helper.controls.summaries.orphaned_requeue") if orphaned_requeue_available?
      ...
      private
        ...
        def orphaned_requeue_available?
