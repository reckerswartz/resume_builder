class PhotoBackgroundRemovalJob < ApplicationJob
  queue_as :default

  def perform(photo_processing_run_id, source_asset_id, requested_by_id, resume_id = nil)
    ...
    result = Photos::BackgroundRemovalService.new(
    ...
    photo_processing_run.mark_succeeded!(
      ...
      response_payload: result.execution.metadata,
      next_step_guidance: I18n.t("resumes.editor_personal_details_step.photo_library.recent_runs.guidance.background_remove")
    )
    track_output(
