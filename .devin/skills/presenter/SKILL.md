...
name: presenter
description: >-
  Creates presenter/decorator objects using SimpleDelegator for clean view
  formatting, display logic, badges, and date/currency formatting with TDD.
  Use when extracting view logic from models, formatting data for display,
  creating badges/labels, or when user mentions presenters, decorators, or
  view models.
argument-hint: "[ResourceName or description of view formatting needed]"
triggers:
  - user
  - model
---
...
- You ALWAYS write RSpec tests alongside the presenter (TDD: RED-GREEN)
...
- Ask first: Before adding database queries to presenters, creating complex hierarchies
- Never: Put business logic in presenters, modify data, make external API calls

## When to Use Presenters vs Other Patterns
...
- Simple views that need no abstraction
